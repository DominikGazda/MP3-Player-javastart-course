...
public class Mp3Parser {
    ...
    public static Mp3Song createMp3FromPath(File file)  throws IOException,TagException{
    ...
    public static List<Mp3Song> createMp3List(File dir) throws IOException, TagException{
        if(!dir.isDirectory()){
            throw new IllegalArgumentException("To nie jest katalog !");
        }
        ...
        for(File f:files){
            ...
            if(fileExtension.equals("mp3")){
                songList.add(createMp3FromPath(f));
            }
        }
        return songList;
    }
